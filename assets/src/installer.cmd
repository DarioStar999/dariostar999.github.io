...
:install_forge
mkdir "%versionpath%\1.8.9-forge1.8.9-11.15.1.2318-1.8.9" nul 2>&1
mkdir "%minecraftpath%\libraries\net\minecraftforge" nul 2>&1 
mkdir "%minecraftpath%\libraries\net\minecraftforge\forge" nul 2>&1
mkdir "%minecraftpath%\libraries\net\minecraftforge\forge\1.8.9-11.15.1.2318-1.8.9" nul 2>&1
